...
class SetupMainWindow:
    ...
    def setup_gui(self):
        ...
        self.add_table_2_row_button = StyledButton(text="Add New Row", themes=self.themes)
        self.delete_table_2_row_button = StyledButton(text="Delete Selected Rows", themes=self.themes)
