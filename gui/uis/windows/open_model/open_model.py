...
class Ui_OpenModelDialog(object):
    def setupUi(self, OpenModelDialog):
        ...
        self.deleteModel = QPushButton(OpenModelDialog)
        self.deleteModel.setObjectName("deleteModel")
        self.verticalLayout.addWidget(self.deleteModel)
        self.horizontalLayout_4.addLayout(self.verticalLayout)
        self.modelList = QListView(OpenModelDialog)
        self.modelList.setObjectName("modelList")
        self.horizontalLayout_4.addWidget(self.modelList)
    ...
    def retranslateUi(self, OpenModelDialog):
        ...
        self.deleteModel.setText(_translate("OpenModelDialog", "Delete Model"))
