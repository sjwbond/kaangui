...
class Ui_OpenModelDialog(object):
    def setupUi(self, OpenModelDialog):
        ...
        self.horizontalLayout_4.addLayout(self.verticalLayout, 1)
        self.verticalLayout_3 = QVBoxLayout()
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.label_2 = QLabel(OpenModelDialog)
        self.label_2.setObjectName("label_2")
        self.verticalLayout_3.addWidget(self.label_2)
        self.versionList = QTableWidget(OpenModelDialog)
        self.versionList.setObjectName("versionList")
        self.verticalLayout_3.addWidget(self.versionList)
        self.horizontalLayout_4.addLayout(self.verticalLayout_3, 2)
